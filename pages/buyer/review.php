...
if ($exists->num_rows > 0) {
    ...
    $reviewed_id = $conn->query("SELECT l.user_id FROM orders o JOIN listings l ON o.listing_id = l.id WHERE o.id = $order_id")->fetch_assoc()['user_id'];
    
    $stmt = $conn->prepare("INSERT INTO reviews (order_id, reviewer_id, reviewed_id, rating, comment, type) VALUES (?, ?, ?, ?, ?, 'buyer_to_farmer')");
