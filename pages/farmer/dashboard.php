...
require_login();
if ($_SESSION['role'] !== 'farmer') { header("Location: /FARMER_MARKET/index.php"); exit; }
...
.dashboard-menu li:nth-child(4) a:before {
    content: '👤';
}
...
<div class="welcome-card">
    ...
    <p>Manage your farm products and sales from here</p>
</div>

<div class="dashboard-header">
    <h2>Farmer Dashboard</h2>
    <p>Choose an option to manage your farm business</p>
</div>
